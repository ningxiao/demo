function Neo4jD3(_selector, _options) {
    ...
    function appendRingToNode(node) {
        ...
        appendImageToNode(node).attr('class', 'ico-l');
        appendImageToNode(node).attr('class', 'ico-r');
        return circle;
    }
    ...
    function appendTitleToRelationship(r) {
        return r.append('title').text(function (d) {
            return toString(d);
        });;
    }
    function appendRelationshipToGraph() {
        var relationship = appendRelationship(),
            ...
            title = appendTitleToRelationship(relationship);
