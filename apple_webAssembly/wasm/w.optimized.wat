(module
 ...
 (data (i32.const 304) "\04\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\13\0d\00\00\02")
 ...
 (global $assembly/w/w (mut i32) (i32.const 0))
 (global $assembly/w/h (mut i32) (i32.const 0))
 (global $assembly/w/s (mut i32) (i32.const 0))
 ...
 (export "sum" (func $assembly/w/sum))
 (export "init" (func $assembly/w/init))
 (export "test" (func $assembly/w/test))
 ...
 (func $assembly/w/sum (; 28 ;) (type $FUNCSIG$dii) (param $0 i32) (param $1 i32) (result f64)
  (local $2 i32)
  (local $3 f64)
  loop $loop|0
   block $break|0
 ...
 (func $assembly/w/init (; 29 ;) (type $FUNCSIG$vii) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  ...
  (local $8 i32)
  local.get $0
  global.set $assembly/w/w
  local.get $1
  global.set $assembly/w/h
  local.get $0
  local.get $1
  i32.mul
  global.set $assembly/w/s
  i32.const 1
  local.set $3
  loop $loop|0
   block $break|0
 ...
 (func $assembly/w/test (; 30 ;) (type $FUNCSIG$di) (param $0 i32) (result f64)
  (local $1 i32)
  (local $2 f64)
  loop $loop|0
   local.get $1
