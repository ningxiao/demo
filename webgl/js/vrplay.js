...
function mousecall() {
	...
	function mousemove(ev) {
		...
		ev.preventDefault();
		ev = (ev.touches && ev.touches[0]) || ev;
		dX = (ev.pageX - old_x) * Math.PI / config.width;
		dY = (ev.pageY - old_y) * Math.PI / config.height;
		THETA += dX;
		PHI += dY;
		old_x = ev.pageX;
		old_y = ev.pageY;
...
function createpgl() {
	...
	vertices = new Float32Array([
		//x  y  z   u  v
		//后面
		-120.0, -120.0, -120.0, (0.66666 + jw), (0.0 + jh), -120.0, 120.0, -120.0, (0.66666 + jw), (0.5 - jh),
		120.0, 120.0, -120.0, (1.0 - jw), (0.5 - jh),
		120.0, -120.0, -120.0, (1.0 - jw), (0.0 + jh),
		// 前面
		-120.0, -120.0, 120.0, (0.66666 - jw), (0.0 + jh),
		120.0, -120.0, 120.0, (0.33333 + jw), (0.0 + jh),
		120.0, 120.0, 120.0, (0.33333 + jw), (0.5 - jh), -120.0, 120.0, 120.0, (0.66666 - jw), (0.5 - jh),
		//顶面
		-120.0, 120.0, -120.0, (1.0 - jw), (1.0 - jh), -120.0, 120.0, 120.0, (1.0 - jw), (0.5 + jh),
		120.0, 120.0, 120.0, (0.66666 + jw), (0.5 + jh),
		120.0, 120.0, -120.0, (0.66666 + jw), (1.0 - jh),
		//底部
		-120.0, -120.0, -120.0, (0.33333 - jw), (0.0 + jh),
		120.0, -120.0, -120.0, (0.0 + jw), (0.0 + jh),
		120.0, -120.0, 120.0, (0.0 + jw), (0.5 - jh), -120.0, -120.0, 120.0, (0.33333 - jw), (0.5 - jh),
		//模型左侧 视图右侧面
		-120.0, -120.0, 120.0, (0.0 + jw), (0.5 + jh), -120.0, 120.0, 120.0, (0.0 + jw), (1.0 - jh), -120.0, 120.0, -120.0, (0.33333 - jw), (1.0 - jh), -120.0, -120.0, -120.0, (0.33333 - jw), (0.5 + jh),
		//模型右侧 视图左侧面
		120.0, -120.0, -120.0, (0.33333 + jw), (0.5 + jh),
		120.0, 120.0, -120.0, (0.33333 + jw), (1.0 - jh),
		120.0, 120.0, 120.0, (0.66666 - jw), (1.0 - jh),
		120.0, -120.0, 120.0, (0.66666 - jw), (0.5 + jh)
	]);
	//顶点索引数据
	...
	mat4.rotateY(mmatrix, mmatrix, THETA);
	mat4.rotateX(mmatrix, mmatrix, PHI);
	mat4.lookAt(vmatrix, new Float32Array([0, 0, distance]), new Float32Array([0, 0, 200]), new Float32Array([0, 1, 0]));
	mat4.perspective(pmatrix, Math.PI * 60 / 180, config.width / config.height, 1, 340);
